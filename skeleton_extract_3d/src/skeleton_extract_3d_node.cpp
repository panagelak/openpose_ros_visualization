      ...
      for (size_t bodypart_idx = 0; bodypart_idx < num_bodyparts; bodypart_idx++)
      {
        ...
        switch (bodypart_idx)
        {
          case 0: bodypart_detections = skeleton_detections.nose;
                  person_msg.nose = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "Nose"); break;
          case 1: bodypart_detections = skeleton_detections.neck;
                  person_msg.neck = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "Neck"); break;
          case 2: bodypart_detections = skeleton_detections.right_shoulder;
                  person_msg.right_shoulder = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RShoulder"); break;
          case 3: bodypart_detections = skeleton_detections.right_elbow;
                  person_msg.right_elbow = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RElbow"); break;
          case 4: bodypart_detections = skeleton_detections.right_wrist;
                  person_msg.right_wrist = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RWrist"); break;
          case 5: bodypart_detections = skeleton_detections.left_shoulder;
                  person_msg.left_shoulder = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LShoulder"); break;
          case 6: bodypart_detections = skeleton_detections.left_elbow;
                  person_msg.left_elbow = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LElbow"); break;
          case 7: bodypart_detections = skeleton_detections.left_wrist;
                  person_msg.left_wrist = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LWrist"); break;
          case 8: bodypart_detections = skeleton_detections.mid_hip;
                  person_msg.mid_hip = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "MidHip"); break;
          case 9: bodypart_detections = skeleton_detections.right_hip;
                  person_msg.right_hip = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RHip"); break;
          case 10:bodypart_detections = skeleton_detections.right_knee;
                  person_msg.right_knee = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RKnee"); break;
          case 11:bodypart_detections = skeleton_detections.right_ankle;
                  person_msg.right_ankle = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RAnkle"); break;
          case 12:bodypart_detections = skeleton_detections.left_hip;
                  person_msg.left_hip = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LHip"); break;
          case 13:bodypart_detections = skeleton_detections.left_knee;
                  person_msg.left_knee = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LKnee"); break;
          case 14:bodypart_detections = skeleton_detections.left_ankle;
                  person_msg.left_ankle = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LAnkle"); break;
          case 15:bodypart_detections = skeleton_detections.right_eye;
                  person_msg.right_eye = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "REye"); break;
          case 16:bodypart_detections = skeleton_detections.left_eye;
                  person_msg.left_eye = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LEye"); break;
          case 17:bodypart_detections = skeleton_detections.right_ear;
                  person_msg.right_ear = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "REar"); break;
          case 18:bodypart_detections = skeleton_detections.left_ear;
                  person_msg.left_ear = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LEar"); break;
          case 19:bodypart_detections = skeleton_detections.left_big_toe;
                  person_msg.left_big_toe = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LBigToe"); break;
          case 20:bodypart_detections = skeleton_detections.left_small_toe;
                  person_msg.left_small_toe = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LSmallToe"); break;
          case 21:bodypart_detections = skeleton_detections.left_heel;
                  person_msg.left_heel = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "LHeel"); break;
          case 22:bodypart_detections = skeleton_detections.right_big_toe;
                  person_msg.right_big_toe = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RBigToe"); break;
          case 23:bodypart_detections = skeleton_detections.right_small_toe;
                  person_msg.right_small_toe = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RSmallToe"); break;
          case 24:bodypart_detections = skeleton_detections.right_heel;
                  person_msg.right_heel = get3dcoordinates(bodypart_detections , temp_cloud, max.x, min.x, max.y, min.y, max.z , min.z, "RHeel"); break;
        }
      }
